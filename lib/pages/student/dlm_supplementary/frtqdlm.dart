...
class FRTQDLM extends StatefulWidget {
  ...
  const FRTQDLM(
      ...
      : super(key: key);
  @override
  FRTQDLMState createState() => FRTQDLMState();
}

class FRTQDLMState extends State<FRTQDLM> {
  Future<List<DLM>>? dlm;
  final dlmListKey = GlobalKey<FRTQDLMState>();
